...
var Button = (props) => {
  ...
  return /* @__PURE__ */ jsx(styled.button, __spreadProps(__spreadValues({}, rest), { className: button({ variant, shape, fill }), children }));
};
...
var Text = (props) => {
  ...
  return /* @__PURE__ */ jsx2(styled2.p, __spreadProps(__spreadValues({}, rest), { className: text({ size }), "data-scope": "p", children }));
};
...
var SplashSection = (props) => {
  ...
  return /* @__PURE__ */ jsxs(Box, { children: [
    splashImageNode,
    /* @__PURE__ */ jsx3(Box, { position: "absolute", bottom: "0", width: "98%", children: /* @__PURE__ */ jsxs(
      Box,
      {
        padding: "3rem",
        position: "relative",
        ...
        children: [
          /* @__PURE__ */ jsx3(Box, { children: /* @__PURE__ */ jsx3(Text, { color: "#222", fontWeight: "bold", fontSize: "20px", children: title }) }),
          /* @__PURE__ */ jsx3(Box, { display: "flex", flexDirection: "column", justifyContent: "center", children: buttonNode })
        ]
      }
    ) })
  ] });
...
import { Box as Box2, Flex } from "@tms/styled-system/jsx";
...
var ImageToggle = (props) => {
  ...
  return /* @__PURE__ */ jsx4(Box2, { p: "1.6rem", onMouseEnter: () => handleMouseEvent(), children: /* @__PURE__ */ jsx4(
    Box2,
    {
      h: "100%",
      w: "100%",
      ...
      children: /* @__PURE__ */ jsx4(Box2, { h: "100%", overflow: "hidden", children: /* @__PURE__ */ jsx4(
        Box2,
        {
          className: css({
...
var parts = defineParts(avatarAnatomy.build());
...
var parts2 = defineParts(carouselAnatomy.build());
...
var parts3 = defineParts(checkboxAnatomy.build());
...
var parts4 = defineParts(colorPickerAnatomy.build());
...
var parts5 = defineParts(dialogAnatomy.build());
...
import { dialogAnatomy as dialogAnatomy2 } from "@ark-ui/react";
var parts6 = defineParts(dialogAnatomy2.build());
...
var parts7 = defineParts(hoverCardAnatomy.build());
...
import { dialogAnatomy as dialogAnatomy3 } from "@ark-ui/react";
var parts8 = defineParts(dialogAnatomy3.build());
...
var parts9 = defineParts(menuAnatomy.build());
var baseItemStyle = {
  alignItems: "center",
  borderRadius: "md",
  color: "fg.emphasized",
...
var parts10 = defineParts(numberInputAnatomy.build());
var trigger = {
  alignItems: "center",
  appearance: "none",
  cursor: "pointer",
...
var parts11 = defineParts(paginationAnatomy.build());
...
var parts12 = defineParts(pinInputAnatomy.build());
...
var parts13 = defineParts(popoverAnatomy.build());
...
var parts15 = defineParts(radioGroupAnatomy.build());
...
var parts16 = defineParts(ratingGroupAnatomy.build());
...
var parts17 = defineParts(segmentGroupAnatomy.build());
...
var parts18 = defineParts(selectAnatomy.build());
...
var parts19 = defineParts(sliderAnatomy.build());
...
var parts20 = defineParts(splitterAnatomy.build());
...
var parts21 = defineParts(switchAnatomy.build());
...
var parts22 = defineParts(tabsAnatomy.build());
...
var parts23 = defineParts(tagsInputAnatomy.build());
...
var parts24 = defineParts(toastAnatomy.build());
...
var parts25 = defineParts(tooltipAnatomy.build());
